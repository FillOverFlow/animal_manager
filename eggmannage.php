          ...
          <table class="table table-bordered  mt-2">
            <thead>
              <tr>
                ...
                <th scope="col">วันที่ไข่</th>
                <th scope="col">วันที่พักไข่</th>
                <th scope="col">วันตรวจ</th>
                <th scope="col">มีเชื้อ</th>
                <th scope="col">ไม่มีเชื้อ</th>
                <th scope="col">สูญเสีย</th>
                <th scope="col">ตายโคม</th>
            ...
            <tbody>
              <tr>
                ...
                <td>-</td>
                <td>-</td>
                <td><a class="btn btn-light editegg"><img src="picture/gg.png" width="20px" height="20px"></a></td>
