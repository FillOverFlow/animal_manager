  ...
  <div class="row m-5">
    ...
    <div class="col-10">
      ...
      <div class="float-right">
        <a href="usermanage.php" class="btn-light user">ผู้ใช้งาน</a>&nbsp;<b>|</b>&nbsp;<a class="btn-light" href="code/login/logout.php">ออกจากระบบ</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </div>
        ...
        <div class="row">
          <div class="col-sm-6 offset-md-3 mt-2 p-3" align="center">
            <form action="annimal_search.php" method="POST">
              ...
              <input required type="text" style="width: 60%;" name="annimal_name_search" class="form-control float-left" id="annimal_name_search" value="">
          ...
          <div class="col-sm-8 offset-md-2" style="height: 333px; overflow:auto; ">
            <table class="table table-bordered mt-5"> 
              ...
              <tbody id="tb1">
                ...
                $seaech = $_POST['annimal_name_search'];
                echo $search;
                if($seaech == ""){
                  echo "ไม่พบข้อมูล";
                }else{
                  $sql = "SELECT * FROM Animal_Type WHERE status = '1' and Animal_Type_Name like '%".$seaech."%' ";
                  // echo $sql;
