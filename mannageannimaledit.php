...
<div id="display-2" class="col-9 p-5 border border-dark rounded h-80 w-100"> 
  ...
  <div class="row mt-5">
    ...
    <div class="col-10">
      ...
      <center> <a><button class="btn btn-dark addhlive">เพิ่มชื่อสามัญ</button></a>&nbsp;&nbsp;<label>ค้นหา :&nbsp;&nbsp;</label><input type="text" name="annimal_name_search" class="form">&nbsp;&nbsp;<input type="submit" class="btn btn-dark" value="ค้นหา"></center>
  ...
  <button class='btn btn-dark float-right'>รายงานการนำไปใช้ประโชยน์<br>ของสัตว์กรณีแก้ไข</button>
