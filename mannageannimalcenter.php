...
<div id="display-2" class="col-sm-9 p-5 border border-dark rounded h-80 w-100"> 

  <div class="row mt-5">
    <div class="col-sm-12">

      <center>
        <a href="addcase.php"><button class="btn btn-light">เพิ่มคดี</button></a>&nbsp;&nbsp;<label>ค้นหา :&nbsp;&nbsp;</label><input type="text" name="annimal_name_search" class="form">&nbsp;&nbsp;<input type="submit" class="btn btn-light" value="ค้นหา">
      </center>
      ...
      <table class="table mt-5">
        ...
        <tbody>
          <tr>
            ...
            <td>-</td>
            <td>-</td>
            <td><a class="btn btn-light" href="showcase.php"><img src="picture/magnifyingglass.png" width="20px" height="20px"></a></td>
            <td>-</td>
            <td>+</td>
            <td>-</td>
            <td>+</td>
            <td>-</td>
            <td><a class="btn btn-light" href="editcase.php"><img src="picture/gg.png" width="20px" height="20px"></a></td>
