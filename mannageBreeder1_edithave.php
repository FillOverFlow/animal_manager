...
<body>
  ...
  <div id="display-2" class="col-9 p-5 border border-dark rounded h-80 w-100"> 
    ...
    <div class="row p-5">
      ...
      <div class="col-4">
        ...
        <div class="row mt-2">
          ...
          <tr>
            <th><button style="margin-left: 65px;" class="btn btn-dark float-right">เพิ่มรูป</button>
            </th>
          </tr>
        </div>
      </div>
    ...
    <center><button class="btn btn-dark">บันทึก</button>&nbsp;&nbsp;<button class="btn btn-dark">ยกเลิก</button></center>
