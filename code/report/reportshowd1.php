...
<body onload="window.print()">
  ...
  <div id="display-2" class="col-10 offset-1 p-5 border border-dark rounded h-80 w-100"> 
      ...
      <div class="row m-10 ">
        <center><tr>
          <th>
            ...
            <?php }else{ ?>
              <img id="img" align="center" src="../mannageannimalcenterhdead/picture/<?php echo $datajoin[0]['W_A_E_Photo_1'] ;?>"  width="300px" class="border border-dark">
            <?php }?>
            <?php
            $img = array(
            ...
            for ($i=0; $i < 5; $i++) {  
              if($img[$i] == ""){
                ...
                <img id="img" style="margin: 2px 0 0 0;" align="center" src="../mannageannimalcenterhdead/picture/<?php echo $img[$i] ;?>"  height="50px" class="border border-dark">
              <?php  }
            } ?>
