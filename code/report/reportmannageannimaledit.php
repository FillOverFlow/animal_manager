  ...
  <div id="print">
    <div class="row" style="margin-top: 50px" >
      <div class="container-fluid" align="center">
        <h5>รายงานสรุปผล สถานะการนำไปใช้ประโชยน์<br>ข้อมูลประเภท สัตว์กรณีแก้ไข</h5>
      </div>
    </div>
    <div class="row" >
          ...
          <tbody>
            ...
            // echo $data[$key]['Animal_ID'];
              ...
              <tr>
                ...
                <td style="padding: 10px;">
                  <?php
                  $sum = getcountall1($value['Animal_Type_ID'],1); 
                ...
                <td style="padding: 10px;">
                  <?php
                  $sum = getcountall1($value['Animal_Type_ID'],2); 
                  if ($sum>0) {
                   echo $sum;
                 }else{
                  echo "-";
                ...
                <td style="padding: 10px;">
                  <?php
                  $sum = getcountall1($value['Animal_Type_ID'],3); 
                  if ($sum>0) {
                   echo $sum;
                 }else{
                  echo "-";
                ...
                <td style="padding: 10px;">
                  <?php
                  $sum = getcountall1($value['Animal_Type_ID'],4); 
                  if ($sum>0) {
                   echo $sum;
                 }else{
                  echo "-";
