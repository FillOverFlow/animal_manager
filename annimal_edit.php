...
<body>
  ...
  <div id="display-2" class="col-9 p-5 border border-dark rounded h-80 w-100"> 
    ...
    <form action="code/annimal_edit.php" method="POST" enctype="multipart/form-data"> 
      <div class="row p-5">
        <div class="col-6">
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <select style="width: 100%;" name="Animal_Type">
                    <?php 
                    $selecttype = "SELECT * FROM animal_type WHERE status = '1'"; 
                    echo $selecttype;
                    $querytype = $conn->query($selecttype);
                    while ($datatype = $querytype->fetch_assoc()) {
                      if ($datatype['Animal_Type_ID'] == $data['Animal_Type_ID']) {?>

                        <option value="<?php echo $datatype['Animal_Type_ID']; ?>" selected><?php echo $datatype['Animal_Type_Name']; ?></option>

                      <?php  }else{ ?> 
                        <option value="<?php echo $datatype['Animal_Type_ID']; ?>" ><?php echo $datatype['Animal_Type_Name']; ?></option>
                      <?php }
                    }
                    ?>
                ...
                <tr>
                  ...
                  <td><input type="text" name="Thai_Common_Name" value="<?php echo $data['Thai_Common_Name']; ?>">
                    <input type="hidden" name="Animal_ID" value="<?php echo $_GET['Animal_ID']?>"></td>
                  </tr>

                  <tr>
                    <th><label class="float-right">ชื่อสามัญอังกฤษ :</label>
                    </th>
                    <td><input type="text" name="English_Common_Name" value="<?php echo $data['English_Common_Name']; ?>"></td>
                  </tr>

                  <tr>
                    <th><label class="float-right">ชื่อวิทยาศาสตร์ :</label>
                    </th>
                    <td><input type="text" name="Scientific_Name" value="<?php echo $data['Scientific_Name']; ?>"></td>
                  </tr>

                  <tr>
                    <th><label class="float-right">ลักษณะทั่วไป :</label>
                    </th>
                    <td><textarea style="width: 100%;" name="General_Characteristics"><?php echo $data['General_Characteristics'];?></textarea></td>
                  </tr>
                </tbody>
              </table>
            ...
            <div class="col">
              ...
              <div class="row" >
                <div class="col-6" align="center">
                  <tr>
                    <th><img id="img" src="<?php echo $data['Animal_Photo']; ?>" width="200px" class="border border-dark">
                    </th>
                  </tr>
                </div>
              ...
              <div class="row mt-2">
                <div class="col" align="center">
                  <th><input width="100px" OnChange="Preview(this)" class="form-control"    type="file" name="annimalimg[]" accept="image/*"></th>
                </div>
                <div class="col" align="center">
                  <tr>
              ...
              <div class="row" align="center">
                ...
                <div class="col mt-2">
                  <tr>
                    <th><button type="button" class="btn btn-light" onclick="PrintDiv();">พิมพ์ QR-code</button>
                    </th>
                  </tr>
                </div>
              </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content p-3">
            ...
            <div class="modal-body">
              <img src="<?php echo $data['QR_Code_Name'];?>" width="100%" height="100%" class="border border-dark">
            </div>
            <div class="mt-2">
