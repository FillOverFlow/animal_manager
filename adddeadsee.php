...
$dataall = showAnimalDataedit($Animal_Case_Correction,1);
$max = count($dataall);
$list = [];
$next;
$last;
   ...
   <center><button class="btn btn-light backButton" ><<</button>&nbsp;
    ...
    <div class="mt-5 row">
      ...
      <div class="col float-right" align="right">
        <label><?php echo $page; echo "/"; echo $max; ?></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="code/report/reportadddeadsee.php?Animal_Case_Correction_ID=<?php echo $Animal_Case_Correction_ID;?>" target="_blank"><img class="" src="picture/prin.png" width="50" height="50"> </a>
      </div>
    </div>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
        ...
        $('.nextButton').on('click',function (e){
            ...
            window.location.replace("http://localhost/animal_manager/adddeadsee.php?Animal_Case_Correction_ID="+<?php echo $nextshow; ?>);
          })

        $('.backButton').on('click',function (e){
            //call back Query Here
            window.location.replace("http://localhost/animal_manager/adddeadsee.php?Animal_Case_Correction_ID="+<?php echo $lastshow; ?>);
          })
