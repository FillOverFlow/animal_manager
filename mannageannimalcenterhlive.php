...
$dataanimal = showAnimalData($tblanimal);
$datawild_animal_exhibits = showAnimalData($tblwild_animal_exhibits);
$datajoin = joinshow();
var_dump($datajoin);
?>
<!doctype html>
      ...
      <div class="col-10">
        ...
        <center>
          ...
          <table class="table mt-2">
            ...
            <tbody>
              <tr>
                <?php   $i =1;foreach ($datawild_animal_exhibits as $key => $value) {?>

                 <th><?php echo $i; ?></th>
                 <td><?php echo $i; ?></td>
                 <td><?php echo $i; ?></td>
                 <td><?php echo $i; ?></td>
                 <td><?php echo $i; ?><a href="addh1.php" class="btn btn-light" href="#"><img src="picture/plus.png" width="25px" height="20px"></a></td>
                 <td><?php echo $i; ?><button class="btn btn-light deleteannimal"><img src="picture/delete.png" width="20px" height="20px"></button></td>
            ...
            <tbody>
              ...
              foreach($dataanimal as $key => $value){?>
                <tr>
                 ...
                 <td><input type="checkbox" name="เสือดำ" value="<?php echo $value['Animal_ID'];?>"></td>
               </tr>
               <?php  $i++;  }?>
             </tbody>
