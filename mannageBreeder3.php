...
<div id="display-2" class="col-9 p-5 border border-dark rounded h-80 w-100"> 
  ...
  <div class="row mt-5">
    ...
    <div class="col-10">
      ...
      <center><form>
        <a class="btn btn-light" href="mannageBreeder3_Match.php">เพิ่มข้อมูลจับคู่</a>&nbsp;&nbsp;<label>ค้นหา :&nbsp;&nbsp;</label><input type="text" name="annimal_name_search" class="form">&nbsp;&nbsp;<input type="submit" class="btn btn-light" value="ค้นหา">
      </form></center>

      <p>ค้นหาข้อมูลการจับคู่พ่อ-แม่พันธุ์</p>
      <table class="table mt-2">
        ...
        <tbody>
          <tr>
            ...
            <td>-</td>
            <td>-</td>
            <td><a class="btn btn-light" href="mannageBreeder3_Match_see.php"><img src="picture/magnifyingglass.png" width="20px" height="20px"></a></td>
            <td><a class="btn btn-light" href="mannageBreeder3_Matchedit.php"><img src="picture/gg.png" width="20px" height="20px"></a></td>
