      ...
      <table class="table mt-2">
        ...
        <tbody>
          <tr>
            ...
            <td>-</td>
            <td>001</td>
            <td><a class="btn btn-light" href="showh1.php"><img src="picture/magnifyingglass.png" width="20px" height="20px"></a></td>
            <td><a class="btn btn-light" href="edith1.php"><img src="picture/gg.png" width="20px" height="20px"></a></td>
