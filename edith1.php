  ...
  <div id="display-2" class="col-9 p-5 border border-dark rounded h-80 w-100"> 
    ...
    <div class="row p-5">
      <div class="col-4">
       ...
       <form action="code/mannageannimalcenterhlive/edith1.php" method="POST" enctype="multipart/form-data">
        <table>
          <thead>
            <tr>
        ...
        <tr>
          <th><label  required class="float-right">สะถานะสุขถาพสัตว์ :</label>
          </th>
          <td><select required name="W_A_E_Animal_Health_Status" style="width: 100%;" class="form-control">
            <?php if($datajoin[0]['W_A_E_Animal_Health_Status'] == 0){ ?>
              <option value="0" selected>เลือกสะถานะสัตว์</option>
              <option value="1">สมบูรณ์</option>
              <option value="2">อื่น ๆ</option>
            <?php }else if($datajoin[0]['W_A_E_Animal_Health_Status'] == 1){ ?>
              <option value="0" >เลือกสะถานะสัตว์</option>
              <option value="1" selected>สมบูรณ์</option>
              <option value="2">อื่น ๆ</option>
            <?php }else if($datajoin[0]['W_A_E_Animal_Health_Status'] == 2){ ?>
              <option value="0" >เลือกสะถานะสัตว์</option>
              <option value="1" >สมบูรณ์</option>
              <option value="2" selected>อื่น ๆ</option>
            <?php } ?>
          </select></td>
        </tr>
